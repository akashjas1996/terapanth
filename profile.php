...
<body>
  ...
  <a href="index.php"><button class="btn btn-primary"><i class="fas fa-home mr-1"></i> Home</button></a>
</div>
  ...
  <div style="height: 100vh">
    ...
    <?php
      $user_id = $_GET['id'];
      $query_data = "SELECT * FROM `reg_users` WHERE `user_id`='$user_id'";
    ...
    <section class="px-md-5 mx-md-5 dark-grey-text text-center text-lg-left">
      ...
      <div class="row">
        ...
        <div class="col-lg-9 mb-4 mb-lg-0">
          ...
          <p class="text-muted">DOB: <td><?php echo $row_users['DOB'] ?></td> </p>
          <p class="text-muted">Blood Group: <td><?php echo $row_users['blood_group'] ?></td> </p>
          <p class="text-muted">Gotra: <td><?php echo $row_users['gotra'] ?></td> </p>
          
          <p class="text-muted">Spouse Name: <td><?php echo $row_users['spouse'] ?></td> </p>
          <p class="text-muted">Marriage Date: <td><?php echo $row_users['marriage_date'] ?></td> </p>

          <p>Contact Number: <?php echo $row_users['phone1'] ?>
            &nbsp; &nbsp;<?php echo $row_users['phone2'] ?></p>
          <p></p>
          <p class="text-muted">Present Address:<td><?php echo $row_users['present_address'] ?></td> </p>

          <p class="text-muted">Permanent Address:<td><?php echo $row_users['permanent_address'] ?></td> </p>
          <?php $prim_cont = $row_users['phone1'] ?>
          <a href="tel:<?php echo $prim_cont ?>"><button class="btn btn-primary"><i class="fas fa-phone mr-1"></i> Call</button></a>
